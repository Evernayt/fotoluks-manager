...
interface SubtractFromSuppliesToolbarProps {
  reload: () => void;
...
const SubtractFromSuppliesToolbar: FC<SubtractFromSuppliesToolbarProps> = ({
  reload,
  onLimitChange,
}) => {
  ...
  const searchHandler = (search: string) => {
    dispatch(moyskladActions.setSubtractFromSuppliesSearch(search));
  };
...
export default SubtractFromSuppliesToolbar;
